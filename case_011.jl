...
materials = HomogenousMaterialProperties{Float_used}(
    3.0,                    # k_rock - thermal conductivity of rock [W/(m·K)]                      # CHANGED 
    1800000,                 # rho_c_rock - volumetric heat capacity [J/(m³·K)]                     # CHANGED
    0.59,                    # k_water [W/(m·K)]
...
boreholes2 = tuple(
    (Borehole{Float_used}(
        xc,                      # xc [m]
        yc,                      # yc [m]
        2400,                   # h - borehole depth [m]                                       # CHANGED 
...
# Inlet model
# =============================================================================
Q = 320000                             # heat extraction rate [W]                  # CHANGED 
