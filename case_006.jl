...
materials = HomogenousMaterialProperties{Float_used}(
    4.4,                    # k_rock - thermal conductivity of rock [W/(m·K)]                      # CHANGED 
    2200000,                 # rho_c_rock - volumetric heat capacity [J/(m³·K)]                     # CHANGED
    0.59,                    # k_water [W/(m·K)]
...
boreholes2 = tuple(
    (Borehole{Float_used}(
        xc,                      # xc [m]
        yc,                      # yc [m]
        2500,                   # h - borehole depth [m]                                       # CHANGED 
...
# Inlet model
# =============================================================================
Q = 180000                             # heat extraction rate [W]                  # CHANGED 
