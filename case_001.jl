...
Pkg.instantiate()
Pkg.add(["GeothermalWells", "OrdinaryDiffEqStabilizedRK", "KernelAbstractions", "JLD2", "CUDA"])
...
materials = HomogenousMaterialProperties{Float_used}(
    2.55,                    # k_rock - thermal conductivity of rock [W/(m·K)]                      # CHANGED 
    2.356e6,                 # rho_c_rock - volumetric heat capacity [J/(m³·K)]                     # CHANGED
    0.59,                    # k_water [W/(m·K)]
...
# Inlet model
# =============================================================================
Q = 50e3                             # heat extraction rate [W]                  # CHANGED 
