...
# Same setup as array_study_01.jl but constant inlet and different borehole depth.
...
# Inlet model
# =============================================================================
inlet_model = ConstantInlet{FloatT}(20.0)
...
# # sbatch -p mit_preemptable -G h200:1 -c 4 -t 12:00:00 --requeue --mem=64G -J scaling_Q_01 -o scaling_Q_01_%j.out -e scaling_Q_01_%j.err --wrap="julia scaling_Q_study_01.jl"