...
# Same setup as array_study_01.jl but with no diffusion in z direction.
...
# Time integration
# =============================================================================
function rhs_NO_diffusion_z!(du, u, p, t)
    return nothing
end

prob = ODEProblem(rhs_NO_diffusion_z!, T0, tspan, cache)
