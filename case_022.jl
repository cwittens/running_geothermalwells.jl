...
materials = HomogenousMaterialProperties{Float_used}(
    3.3,                    # k_rock - thermal conductivity of rock [W/(m·K)]                      # CHANGED 
...
boreholes2 = tuple(
    (Borehole{Float_used}(
        xc,                      # xc [m]
        yc,                      # yc [m]
        1300,                   # h - borehole depth [m]                                       # CHANGED 
...
# Inlet model
# =============================================================================
Q = 300000                             # heat extraction rate [W]                  # CHANGED 
